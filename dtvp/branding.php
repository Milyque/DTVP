...
<body>
    <section class="main">  
    <p style="color: black;">YOUR BRANDING PERMITS TABLE: 
    <span style="font-synthesis: unset; color: red;">(If no vehicle is on list proceed to add)</span>&nbsp;
    <a href="mpesaBrand/index.php" class="btn">ADD VEHICLE</a>
    <form action="search-brand.php" method="post">
            ...
            while ($row = mysqli_fetch_assoc($vehicle)) {
                ...
                echo "
                    <tr style='padding:10px;'>
                        ...
                        echo "
                         <td><a class='btn2' style='margin: 10px;' href='mpesaBrandrenew/index.php?'>Renew</a></td>
                        ";}
                        echo "
                    </tr>
                ";
